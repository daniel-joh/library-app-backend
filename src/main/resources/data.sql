...
(1, 'Pestens tid', 123456, 'en sammanfattning', 900, 1, 1, 'images/books/king.jpg');
insert into book_descriptions (id, title, isbn, summary, number_of_pages, author_id, genre_id, image_url) values
(2, 'Det', 123789, 'en sammanfattning', 1000, 1, 1, 'images/books/king.jpg');
insert into book_descriptions (id, title, isbn, summary, number_of_pages, author_id, genre_id, image_url) values
(3, 'Christine', 156756, 'en sammanfattning', 800, 1, 1, 'images/books/king.jpg');
insert into book_descriptions (id, title, isbn, summary, number_of_pages, author_id, genre_id, image_url) values
(4, 'Lida', 156756, 'en sammanfattning', 500, 1, 1, 'images/books/king.jpg');
insert into book_descriptions (id, title, isbn, summary, number_of_pages, author_id, genre_id, image_url) values
(5, 'Varsel', 156756, 'en sammanfattning', 600, 1, 1, 'images/books/king.jpg');
insert into book_descriptions (id, title, isbn, summary, number_of_pages, author_id, genre_id, image_url) values
(6, 'Jakten på röd oktober', 345456, 'en sammanfattning', 950, 2, 1, 'images/books/king.jpg');
